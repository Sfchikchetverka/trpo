...
public class MediumBottleFullItem extends Item {

    public MediumBottleFullItem(Properties properties) {
        super(properties);
    }
    ...
    public ItemStack finishUsingItem(ItemStack stack, Level level, LivingEntity entity) {
        ItemStack emptyBottle = new ItemStack(ModItems.MEDIUMBOTTLERAW.get());

        // Добавляем эффект насыщения (можно изменить)
        entity.addEffect(new MobEffectInstance(MobEffects.SATURATION, 5 * 2, 0));
